...
@section('content')
    <div class="container mx-auto mt-8">
        <div class="max-w-xl mx-auto bg-white shadow-md rounded-lg">
            <div class="p-6">
                <h1 class="text-2xl font-semibold text-center text-gray-800 mb-6">Edit Data Laporan</h1>
                <form action="{{ route('category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="">
                        ...
                        <input type="text" id="input-label-with-helper-text" name="name" value="{{ $category->name }}"
                    ...
                    <div class="mt-6">
                        ...
                        <input type="text" id="with-corner-hint" name="description" value="{{ $category->description }}"
                            class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
