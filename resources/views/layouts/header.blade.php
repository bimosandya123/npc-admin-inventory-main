    ...
    <nav class="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
        <div class="me-5 lg:me-0 lg:hidden">
            ...
            <a class="flex-none rounded-md text-xl inline-block font-semibold focus:outline-none focus:opacity-80"
                ...
                <img src="{{ asset('images/logo/logo-npc-lab.png') }}" alt="Logo NPC Lab" width="100">
            </a>
            <!-- End Logo -->
        </div>
        ...
        <div class="w-full flex items-center justify-end ms-auto md:justify-between gap-x-1 md:gap-x-3">
            ...
            <div class="flex flex-row items-center justify-end gap-1">
                ...
                <button type="button"
                    class="hs-dark-mode hs-dark-mode-active:hidden inline-flex items-center gap-x-2 py-2 px-3  rounded-full text-sm text-gray-800 hover:bg-gray-400/20 focus:outline-none focus:bg-gray-800/20"
                ...
                <button type="button"
                    class="hs-dark-mode hs-dark-mode-active:inline-flex hidden items-center gap-x-2 py-2 px-3 rounded-full text-sm text-white hover:bg-white/20 focus:outline-none focus:bg-white/20"
        ...
        <div
            ...
            <nav class="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                <ul class="flex flex-col space-y-1">
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2 px-2.5 @if (Route::is('dashboard')) bg-gray-100 dark:bg-neutral-700 @else hover:bg-gray-100 @endif text-sm text-gray-800 rounded-lg focus:outline-none focus:bg-gray-100 dark:text-white"
                            href="/">
                            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2 px-2.5 @if (request()->is('category*')) bg-gray-100 dark:bg-neutral-700 @else hover:bg-gray-100 @endif text-sm text-gray-800 rounded-lg focus:outline-none focus:bg-gray-100 dark:text-white"
